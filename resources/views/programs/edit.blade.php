        ...
        <header class="header">
            <div class="container header__container" style="text-align: right;">
                <div class="header__logo">
                    <img class="header__img" src="{{asset("images/logo1.png")}}" style="height: 80px; width: 80px" alt="">
        ...
        <div class="container" style="margin-bottom: 300px;">
            <div class="row">
                <div class="container contact-form">
                    <div class="contact-image mb-2">
                        <img src="https://image.ibb.co/kUagtU/rocket_contact.png" alt="rocket_contact"/>
                    </div>
                    <form method="post" action="{{route('programs.update' , $program->id)}}" enctype="multipart/form-data" dir="rtl">
                        @csrf
                        @method('PATCH')
                        <h3>تعديل على البرنامج </h3>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group" style="text-align: right">
                                    <label for="file" >أسم البرنامج</label>
                                    <input type="text" name="name" id="name" for="name" value="{{$program->name}}" class="form-control" placeholder="أدخل أسم البرنامج *" value="" />
                                </div>
                                <div class="form-group" style="text-align: right">
                                    <label for="image" >صورة البرنامج</label>
                                    <input type="file" name="image" id="image" for="image" value="{{$program->image}}" class="form-control" placeholder="صورة البرنامج *" value="" />
                                </div>
                                <div class="form-group" style="text-align: right">
                                    <label for="file" >ملف البرنامج</label>
                                    <input type="file" name="file" id="file" for="file" class="form-control" value="{{$program->file}}" placeholder="ملف البرنامج *" value="" />
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group" style="text-align: right">
                                    <br>
                                    <br>
                                    <label for="file" >وصف البرنامج</label>
                                    <textarea name="desc" id="desc" for="desc" class="form-control" value="{{$program->desc}}" placeholder="أدخل وصف البرنامج *" style="width: 100%; height: 150px;"></textarea>
                                </div>
                            </div>

                        </div> <div class="form-group">
                            <input type="submit" name="btnSubmit" class="btnContact" value="أضافة" style="text-align: center" />
                        </div>
                    </form>
                </div>
            </div>
