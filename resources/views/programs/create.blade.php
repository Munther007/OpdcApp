        ...
        <div class="container" style="margin-bottom: 300px;">
            <div class="row">
                <div class="container contact-form">
                    ...
                    <form method="post" action="{{route('programs.store')}}" enctype="multipart/form-data" dir="rtl">
                        @csrf
                        @method('POST')
                        <h3>أضافة برنامج جديد</h3>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group" style="text-align: right">
                                    <label for="file" >أسم البرنامج</label>
                                    <input type="text" name="name" id="name" for="name" class="form-control" placeholder="أدخل أسم البرنامج *" value="" />
                                </div>
                                <div class="form-group" style="text-align: right">
                                    <label for="image" >صورة البرنامج</label>
                                    <input type="file" name="image" id="image" for="image" class="form-control" placeholder="صورة البرنامج *" value="" />
                                </div>
                                <div class="form-group" style="text-align: right">
                                    <label for="file" >ملف البرنامج</label>
                                    <input type="file" name="file" id="file" for="file" class="form-control" placeholder="ملف البرنامج *" value="" />
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group" style="text-align: right">
                                    ...
                                    <textarea name="desc" id="desc" for="desc" class="form-control" placeholder="أدخل وصف البرنامج *" style="width: 100%; height: 150px;"></textarea>
                                </div>
                            </div>
