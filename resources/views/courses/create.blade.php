...
<div class="contact1">
    <div class="container-contact1">
        ...
        <form class="contact1-form validate-form" dir="rtl" action="{{route("courses.store")}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('POST')
            ...
            <div class="wrap-input1 validate-input" data-validate = "موقع الدورات مطلوب">
                <input class="input1" type="text" for="location" id="location" name="location" placeholder="موقع الدورات ">
                <span class="shadow-input1"></span>
            </div>

            <div class="wrap-input1 validate-input" data-validate = "جدول الدورات مطلوب">
                <input class="input1" type="file" for="image" id="image" name="image" placeholder="جدول الدورات">
                <span class="shadow-input1"></span>
            </div>
