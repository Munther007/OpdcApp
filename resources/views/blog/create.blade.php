            ...
            <div class="row">
                <div class="container contact-form">
                    ...
                    <form method="post" action="{{route('posts.store')}}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <h3>أضافة منشور جديد</h3>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" name="title" id="title" for="title" class="form-control" placeholder="عنوان المنشور *" value="" />
                                </div>

                                <div class="form-group">
                                    <input type="file" name="image" id="image" for="image" class="form-control" placeholder="صورة للمنشور *" value="" />
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <textarea name="body" id="body" for="body" class="form-control" placeholder="محتوى المنشور *" style="width: 100%; height: 150px;"></textarea>
                                </div>
                            </div>
