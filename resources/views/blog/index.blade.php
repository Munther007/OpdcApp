    ...
    <div class="container" >
        ...
        <div class="row row--margin">
            ...
            <div class="col-md-6 article-pre__col">
                <a href="{{route('posts.show' , $post->id)}}" class="article-pre ">
                    <div class="article-pre__img article-pre__img--first">
                        <img src="{{asset('/img/'. $post->image)}}" style="height: 297px; width: 540px" alt="">
                    </div>
                    ...
                    <h1 class="article-pre__title">{{$post->title}}
...
{{--                <img src="{{  asset($imagePath) }}" style="height: 250px; width: 250px;" alt=".."/>--}}
...
{{--                    <p>{{$post->body}}</p>--}}
{{--                    <br>--}}
{{--                    <a href="{{route('posts.show' , $post->id)}}" class="read-more">عرض</a>--}}
{{--                </figcaption>--}}
{{--            </figure>--}}

{{--                <img src="{{  asset( $post->id) }}" style="height: 250px; width: 250px;"/>--}}
