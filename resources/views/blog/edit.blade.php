...
<div class="container" style="margin-bottom: 300px;">
    <div class="row">
        <div class="container contact-form">
            ...
            <form method="post" action="{{route('posts.store') , $post->id}}" enctype="multipart/form-data">
                @csrf
                @method('Patch')
                <h3>التعديل على المنشور </h3>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group" style="text-align: right">
                            <label for="title" >عنوان المنشور</label>
                            <input type="text" name="title" id="title" for="title" value="{{$post->title}}" class="form-control" placeholder="أدخل عنوان المنشور *"  />
                        </div>

                        <div class="form-group" style="text-align: right">
                            <label for="title" >عنوان المنشور</label>
                            <input type="file" name="image" id="image" for="image" value="{{$post->image}}" class="form-control" placeholder="حمل صورة للمنشور *" />
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group" style="text-align: right">
                            <label for="title" >محتوى المنشور</label>
                            <textarea name="body" id="body" for="body" value="{{$post->body}}" class="form-control" placeholder="أدخل محتوى المنشور *" style="width: 100%; height: 150px;"></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group" style="margin-right: 10px; margin-left: 10px">
                    <input type="submit" class="btnContact" value="أضافة" style="text-align: center" />
                </div>
            </form>
        </div>
    </div>
